    ...
    <div className="container position-abs">
      ...
      <div className="detail_">
        <p className="text-center">
          ...
          dictumst. Quisque vel rutrum ipsum.
        </p>
      </div>
    </div>
  </div>
  <div className="list-about-us">
    <div className="item-abu">
      ...
      <div className="abu-content">
        <div className="avt">
          <img src={require("../../Assets/img/abu-1.jpg")} alt="" />
        </div>
        <div className="desc">
    ...
    <div className="item-abu">
      ...
      <div className="abu-content">
        <div className="avt">
          <img src={require("../../Assets/img/abu-2.jpg")} alt="" />
        </div>
          ...
          <div className="content-wrapp">
            <div className="detail">
              <p>
                ...
                rutrum dignissim, malesuada vitae nulla. Sed viverra, nisl
                dapibus lobortis porttitor, risus risus dictum risus, sed
                rhoncus orci urna dignissim leo. Cras id nunc nulla.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="item-abu">
      ...
      <div className="abu-content">
        <div className="avt">
          <img src={require("../../Assets/img/abu-3.jpg")} alt="" />
        </div>
        <div className="desc">
          <h3>extensive menu</h3>
          <div className="content-wrapp">
